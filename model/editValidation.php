...
if (in_array($_SESSION['id'], getTPIsById($tpiChoosen)[0])) {
    ...
    if (!empty(getValidation($tpiChoosen))) {
        $tabValidation = getValidation($tpiChoosen);
        $criterions = explode(';', $tabValidation[0]['criterions']);
    }
    ...
    $form .= <<<FORMVALID
        ...
        <div class="form-group">
            ...
            <textarea style="resize: none;" cols="100" class="form-control" id="comment" name="comment"></textarea>
        </div>
